...
import { bannerUploadSchema } from "@/lib/schemas/banner-upload-schema";
...
export const POST = async (req: NextRequest) => {
  ...
  const validatedData = bannerUploadSchema.safeParse({
    banner,
  });
  ...
  const url = await uploadFile(banner as File);
