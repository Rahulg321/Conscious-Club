...
import { AlertCircle, Check, FilterIcon, X } from "lucide-react";
...
const getOperatorsForField = <T = unknown,>(
  ...
  if (fieldType === "multiselect" || field.type === "multiselect") {
    return operators.multiselect || ([] as FilterOperator[]);
  }
          ...
          >
            <PopoverTrigger asChild>
              {addButton ? (
                ...
                >
                  {addButtonIcon || <FilterIcon className="w-4 h-4" />}
