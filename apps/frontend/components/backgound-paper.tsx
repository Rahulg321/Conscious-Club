...
export default function ShapeHero() {
  ...
  return (
    <div className="relative h-max w-full flex items-center justify-center overflow-hidden bg-white dark:bg-[#030303] py-4">
      <div className="absolute inset-0 bg-linear-to-br from-indigo-500/2 via-transparent to-rose-500/2 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto px-4 md:px-6">
        <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="bg-white/50 rounded-2xl p-8 md:p-12">
              <div className="text-center mb-8">
                ...
                <p className="mt-3 text-base text-gray-600">
                  Got a question or an idea? Send us a message
                </p>
              </div>
          ...
          <motion.div
            ...
            animate="visible"
          >
            <p className="text-base sm:text-lg md:text-xl text-black/50 dark:text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
