...
import { adminEditBlogPost } from "@/lib/actions/blog-posts-actions";
...
const EditBlogPostForm = ({
  ...
  const form = useForm<EditBlogPostSchemaType>({
    resolver: zodResolver(editBlogPostSchema) as any,
    defaultValues: {
      id: post.id,
      title: post.title,
  ...
  const onSubmit = async (values: EditBlogPostSchemaType) => {
    startTransition(async () => {
      try {
        ...
        const response = await adminEditBlogPost({
          ...values,
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                        ...
                        <div className="prose prose-sm dark:prose-invert max-w-none p-4">
                          {field.value ? (
                            ...
                            <p className="text-muted-foreground italic">
                              No content to preview. Start writing to see the
                              preview.
                            </p>
                          )}
                        </div>
                  ...
                  <FormDescription>
                    The full content of your blog post. Markdown is supported
                    (min 50 characters)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  {!featuredImagePreview && !form.watch("featuredImage") && (
                    <Button
                      type="button"
                      variant="outline"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Original URL if this content was published elsewhere first
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
